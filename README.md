# dagmc-basics
Super basic introduction for getting started with DAGMC for particle tracking. A docker image is avaialble with DAGMC's dependencies pre-built (see below) to let you go straight into playing around with it. Instructions for how to build DAGMC and its dependencies locally can be found in the Dockerfile provided. Files included in this repo: 
...
Note that [Coreform Cubit](https://coreform.com/products/coreform-cubit/) (lisence required) is needed to produce the .h5m faceted geometry that DAGMC reads in.
